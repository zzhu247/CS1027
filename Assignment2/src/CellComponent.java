...
public class CellComponent extends JComponent  {
	...
	protected void paintComponent(Graphics g) {
		...
		} else if (c == CellColours.CANDY_PROCESSED || c == CellColours.INITIAL_PROCESSED
				|| c == CellColours.INITIAL_POPPED || c == CellColours.CANDY_POPPED) {
			// Initial and destination cells when they have been reached
			displayed = true;
			Image img;
			if (c == CellColours.CANDY_PROCESSED || c == CellColours.INITIAL_PROCESSED)
