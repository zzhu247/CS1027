		...
		if (tests[3] == 4) {
			...
			try {
				...
				for (int i = 0; i < 256; ++i) {
					...
					if ((i == 21) && (s.length() > 201 || s.length() < 200)) {
						testPassed = false;
						break;
					}
					else if ((i == 201) && (s.length() > 251 || s.length() < 250)) {
						testPassed = false;
						break;
					}
					else if ((i == 251) && (s.length() > 301 || s.length() < 300)) {
						testPassed = false;
						break;
					}
				}
		...
		if (tests[4] == 5) {
			...
			try {
				...
				for (int i = 25; i > 5; --i) {
					...
					if ((i == 23)  && (s.length() > 76 || s.length() < 75)) {
						System.out.println("19: "+s.length());
						testPassed = false;
						break;
					}
					else if ((i == 11) && (s.length() > 26 || s.length() < 25)) {
						System.out.println("9: "+s.length());
						testPassed = false;
						break;
					}
				}
				if (s.length() > 26 || s.length() < 25) testPassed = false;
			} catch (Exception e) {testPassed = false;}
