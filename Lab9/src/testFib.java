...
public class FibonacciDemo {
    ...
    public static long FibonacciBase(int num) {
    	int depth = 0;
    	if (num == 1 || (num == 2)) {
    		depth ++;
    		return 1;
    	} else {
    		long result1 =  FibonacciRecursive(num-1, depth);
    		long result2 = FibonacciRecursive(num-1, depth);
    		return result1 + result2;
    	}
    }
    
    public static long FibonacciRecursive(long num, int depth) {
