...
public class CellColours {
	...
	public static final Color HERO = new Color(250, 250, 0);
	public static final Color INITIAL = new Color(250,250,250);
	public static final Color CANDY = Color.BLUE;
	public static final Color UNVISITED = new Color(100, 255, 100);
	public static final Color IN_STACK = Color.CYAN;
	public static final Color CANDY_PROCESSED = new Color(0, 190, 190);
	public static final Color CANDY_POPPED = new Color(255, 255, 255);
	public static final Color HERO_PROCESSED = new Color(200, 255, 255);
	public static final Color HERO_POPPED = new Color(50, 255, 255);
	...
	public static final Color ZOMBIE = Color.DARK_GRAY;
	public static final Color SUPERHERO = Color.magenta;
	...
	*/
	public Color gradientColor(Color c) {
		...
		else if (c == CANDY_PROCESSED)
			return new Color(0, 0, 180);
		else if (c == HERO_PROCESSED)
			return Color.CYAN.darker();
		else if (c == HERO_POPPED)
			return Color.GRAY;
		return c.darker();
	}
